...
module.exports = function (blogs) {
	...
	blogs.map(function (blog) {
		...
		var agregaResto = '';
		agregaResto = agregaResto + ('\n\t  \t<div class="col l12 posT white sombra">\n\t\t  \t<a href="' + blog.link + '" target="_blank">\n\n\t\t\t\t<div class="col l8  fullH blogDetalle">\n\t\t\t\t\t<h6 class="col l12 subtil  sinPadding left tituls2">' + blog.titulo + '</h6>\n\t\t\t\t\t<h6 class="col l12 paraf  sinPadding sinMargin left cardText">' + blog.descripcion + '</h6>\n\t\t\t\t\t<div class="col l12 bton sinPadding " style="margin: 0 0 10px 0">\n\t\t\t\t\t\t<div class="col l6 sinPadding fecha" style="">' + blog.fecha + '</div>\n\t\t\t\t\t\t<div class="col l6 right-align"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class="col l4 fullH red picBlog mascara" id="picBlog' + n + '"><div class="saberm">Saber M\xE1s...</div></div>\n\t\t\t</a>\n\t\t</div>\n\t  \t');
...
function DatosEventos(ctx, next) {
	request.get('/api/eventos').end(function (err, res) {
...
function DatosAgenda(ctx, next) {
	request.get('/api/agenda').end(function (err, res) {
		if (err) return console.log(err);
		ctx.agenda = res.body;
...
function DatosBlog(ctx, next) {
	request.get('/api/blog').end(function (err, res) {
		if (err) return console.log(err);
		ctx.blog = res.body;
		// console.log(ctx.eventos[0].evento.titulo);
		// sessionStorage.setItem("eventos", ctx.eventos); 
...
function DatosTwitter(ctx, next) {
	request.get('/api/twitter').end(function (err, res) {
		if (err) return console.log(err);
...
},{"./agenda":12,"./blog":13,"./realizados":15,"./twitter":16,"page":3,"superagent":7}],15:[function(require,module,exports){
'use strict';
